...
You can refer to [https://github.com/wzhouad/ATLOP](https://github.com/fenchri/edge-oriented-graph) for the detail preprocessing process of GDA and CDR datasets (acquire the file of train_filter.data，dev_filter.data，test_filter.data).
